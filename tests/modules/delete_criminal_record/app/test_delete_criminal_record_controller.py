...
class Test_DeleteCriminalRecordController:
    ...
    def test_delete_criminal_record_controller_missing_criminal_record_id(self):
        """
    ...
    def test_delete_criminal_record_controller_wrong_criminal_record_id_type(self):
        """
