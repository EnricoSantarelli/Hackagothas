...
class Test_Crime:
    ...
    def test_crime(self):
        ...
        """
        crime = Crime(crime_id="c303282d-f2e6-46ca-a04a-35d3d873712d", crime_description="The crime was extremely violent, leaving 6 citizens injured and 2 dead. The author left few clues behind.",
                      date=1585312648914, responsible_criminal=Test_Crime.criminal, crime_type=CRIME_TYPE.ARSON, crime_region=REGION.AMUSEMENT_MILE, seriousness=SERIOUSNESS.HIGH)

        assert crime.crime_id == "c303282d-f2e6-46ca-a04a-35d3d873712d"
        assert crime.crime_description == "The crime was extremely violent, leaving 6 citizens injured and 2 dead. The author left few clues behind."
        assert crime.date == 1585312648914
        assert crime.responsible_criminal == Test_Crime.criminal
        assert crime.crime_type == CRIME_TYPE.ARSON
        assert crime.crime_region == REGION.AMUSEMENT_MILE
    ...
    def test_crime_id_is_none(self):
        ...
        with pytest.raises(EntityError):
            Crime(crime_id=None, crime_description="The crime was extremely violent, leaving 6 citizens injured and 2 dead. The author left few clues behind.",
                  ...
                  crime_type=CRIME_TYPE.ARSON, crime_region=REGION.AMUSEMENT_MILE, seriousness=SERIOUSNESS.HIGH)
    ...
    def test_crime_id_is_not_str(self):
        ...
        """
        with pytest.raises(EntityError):
            Crime(crime_id=15, crime_description="The crime was extremely violent, leaving 6 citizens injured and 2 dead. The author left few clues behind.",
                  date=1585312648914, responsible_criminal=Criminal(name="VITOR", nickname="O destruidor de API", criminal_description="Esse criminoso terroriza os desenvolvedores front-end derrubando a API minutos antes da entrega. Não se sabe quantas vitimas morreram do coração achando que o erro era do front", gender=GENDER.UNDEFINED, criminal_region=REGION.INDUSTRIAL_DISTRICT, blood_type=BLOOD_TYPE.O_PLUS, age=21, weight=65.6, height=1.90),
                  crime_type=CRIME_TYPE.ARSON, crime_region=REGION.AMUSEMENT_MILE, seriousness=SERIOUSNESS.HIGH)
    ...
    def test_crime_id_size_is_different_than_the_required(self):
        ...
        """
        with pytest.raises(EntityError):
            Crime(crime_id="c303282d-f2e6-46ca-a04a-35d532532523523512", crime_description="The crime was extremely violent, leaving 6 citizens injured and 2 dead. The author left few clues behind.",
                  date=1585312648914, responsible_criminal=Criminal(name="VITOR", nickname="O destruidor de API", criminal_description="Esse criminoso terroriza os desenvolvedores front-end derrubando a API minutos antes da entrega. Não se sabe quantas vitimas morreram do coração achando que o erro era do front", gender=GENDER.UNDEFINED, criminal_region=REGION.INDUSTRIAL_DISTRICT, blood_type=BLOOD_TYPE.O_PLUS, age=21, weight=65.6, height=1.90),
                  crime_type=CRIME_TYPE.ARSON, crime_region=REGION.AMUSEMENT_MILE, seriousness=SERIOUSNESS.HIGH)
    ...
    def test_crime_description_is_not_str(self):
        ...
        """
        with pytest.raises(EntityError):
            Crime(crime_id="c303282d-f2e6-46ca-a04a-35d532532523523512", crime_description=15,
                  date=1585312648914, responsible_criminal=Criminal(name="VITOR", nickname="O destruidor de API", criminal_description="Esse criminoso terroriza os desenvolvedores front-end derrubando a API minutos antes da entrega. Não se sabe quantas vitimas morreram do coração achando que o erro era do front", gender=GENDER.UNDEFINED, criminal_region=REGION.INDUSTRIAL_DISTRICT, blood_type=BLOOD_TYPE.O_PLUS, age=21, weight=65.6, height=1.90),
                  crime_type=CRIME_TYPE.ARSON, crime_region=REGION.AMUSEMENT_MILE, seriousness=SERIOUSNESS.HIGH)
    ...
    def test_crime_date_is_none(self):
        ...
        with pytest.raises(EntityError):
            Crime(crime_id="c303282d-f2e6-46ca-a04a-35d532532523523512", crime_description="The crime was extremely violent, leaving 6 citizens injured and 2 dead. The author left few clues behind.",
                  date=None, responsible_criminal=Criminal(name="VITOR", nickname="O destruidor de API", criminal_description="Esse criminoso terroriza os desenvolvedores front-end derrubando a API minutos antes da entrega. Não se sabe quantas vitimas morreram do coração achando que o erro era do front", gender=GENDER.UNDEFINED, criminal_region=REGION.INDUSTRIAL_DISTRICT, blood_type=BLOOD_TYPE.O_PLUS, age=21, weight=65.6, height=1.90),
                  crime_type=CRIME_TYPE.ARSON, crime_region=REGION.AMUSEMENT_MILE, seriousness=SERIOUSNESS.HIGH)
    ...
    def test_crime_date_is_out_of_range(self):
        ...
        with pytest.raises(EntityError):
            Crime(crime_id="c303282d-f2e6-46ca-a04a-35d532532523523512", crime_description=15,
                  date=41242145153253252353253221321, responsible_criminal=Criminal(name="VITOR", nickname="O destruidor de API", criminal_description="Esse criminoso terroriza os desenvolvedores front-end derrubando a API minutos antes da entrega. Não se sabe quantas vitimas morreram do coração achando que o erro era do front", gender=GENDER.UNDEFINED, criminal_region=REGION.INDUSTRIAL_DISTRICT, blood_type=BLOOD_TYPE.O_PLUS, age=21, weight=65.6, height=1.90),
                  crime_type=CRIME_TYPE.ARSON, crime_region=REGION.AMUSEMENT_MILE, seriousness=SERIOUSNESS.HIGH)

        with pytest.raises(EntityError):
            Crime(crime_id="c303282d-f2e6-46ca-a04a-35d532532523523512", crime_description=15,
                  date=1232131, responsible_criminal=Criminal(name="VITOR", nickname="O destruidor de API", criminal_description="Esse criminoso terroriza os desenvolvedores front-end derrubando a API minutos antes da entrega. Não se sabe quantas vitimas morreram do coração achando que o erro era do front", gender=GENDER.UNDEFINED, criminal_region=REGION.INDUSTRIAL_DISTRICT, blood_type=BLOOD_TYPE.O_PLUS, age=21, weight=65.6, height=1.90),
                  crime_type=CRIME_TYPE.ARSON, crime_region=REGION.AMUSEMENT_MILE, seriousness=SERIOUSNESS.HIGH)
    ...
    def test_crime_criminal_is_none(self):
        ...
        """
        with pytest.raises(EntityError):
            Crime(crime_id="c303282d-f2e6-46ca-a04a-35d532532523523512", crime_description=15, date=41242145153253252353253221321,
                  responsible_criminal=None, crime_type=CRIME_TYPE.ARSON, crime_region=REGION.AMUSEMENT_MILE, seriousness=SERIOUSNESS.HIGH)
    ...
    def test_crime_criminal_is_not_criminal(self):
        ...
        with pytest.raises(EntityError):
            Crime(crime_id="c303282d-f2e6-46ca-a04a-35d532532523523512", crime_description=15, date=41242145153253252353253221321,
                  responsible_criminal=145, crime_type=CRIME_TYPE.ARSON, crime_region=REGION.AMUSEMENT_MILE, seriousness=SERIOUSNESS.HIGH)
    ...
    def test_crime_crime_type_is_none(self):
        ...
        with pytest.raises(EntityError):
            Crime(crime_id="c303282d-f2e6-46ca-a04a-35d532532523523512", crime_description="The crime was extremely violent, leaving 6 citizens injured and 2 dead. The author left few clues behind.",
                  date=1585312648914, responsible_criminal=Criminal(name="VITOR", nickname="O destruidor de API", criminal_description="Esse criminoso terroriza os desenvolvedores front-end derrubando a API minutos antes da entrega. Não se sabe quantas vitimas morreram do coração achando que o erro era do front", gender=GENDER.UNDEFINED, criminal_region=REGION.INDUSTRIAL_DISTRICT, blood_type=BLOOD_TYPE.O_PLUS, age=21, weight=65.6, height=1.90),
                  crime_type=None, crime_region=REGION.AMUSEMENT_MILE, seriousness=SERIOUSNESS.HIGH)
    ...
    def test_crime_crime_type_is_not_crime_type(self):
        ...
        with pytest.raises(EntityError):
            Crime(crime_id="c303282d-f2e6-46ca-a04a-35d532532523523512", crime_description=15,
                  date=1232131, responsible_criminal=Criminal(name="VITOR", nickname="O destruidor de API", criminal_description="Esse criminoso terroriza os desenvolvedores front-end derrubando a API minutos antes da entrega. Não se sabe quantas vitimas morreram do coração achando que o erro era do front", gender=GENDER.UNDEFINED, criminal_region=REGION.INDUSTRIAL_DISTRICT, blood_type=BLOOD_TYPE.O_PLUS, age=21, weight=65.6, height=1.90),
                  crime_type=30, crime_region=REGION.AMUSEMENT_MILE, seriousness=SERIOUSNESS.HIGH)
    ...
    def test_crime_region_is_none(self):
        ...
        with pytest.raises(EntityError):
            Crime(crime_id="c303282d-f2e6-46ca-a04a-35d532532523523512", crime_description="The crime was extremely violent, leaving 6 citizens injured and 2 dead. The author left few clues behind.",
                  date=1585312648914, responsible_criminal=Criminal(name="VITOR", nickname="O destruidor de API", criminal_description="Esse criminoso terroriza os desenvolvedores front-end derrubando a API minutos antes da entrega. Não se sabe quantas vitimas morreram do coração achando que o erro era do front", gender=GENDER.UNDEFINED, criminal_region=REGION.INDUSTRIAL_DISTRICT, blood_type=BLOOD_TYPE.O_PLUS, age=21, weight=65.6, height=1.90),
                  crime_type=None, crime_region=None, seriousness=SERIOUSNESS.HIGH)
    ...
    def test_crime_region_is_not_region(self):
        ...
        with pytest.raises(EntityError):
            Crime(crime_id="c303282d-f2e6-46ca-a04a-35d532532523523512", crime_description=15,
                  date=1232131, responsible_criminal=Criminal(name="VITOR", nickname="O destruidor de API", criminal_description="Esse criminoso terroriza os desenvolvedores front-end derrubando a API minutos antes da entrega. Não se sabe quantas vitimas morreram do coração achando que o erro era do front", gender=GENDER.UNDEFINED, criminal_region=REGION.INDUSTRIAL_DISTRICT, blood_type=BLOOD_TYPE.O_PLUS, age=21, weight=65.6, height=1.90),
                  crime_type=30, crime_region="São Caetano do Sul", seriousness=SERIOUSNESS.HIGH)
    ...
    def test_crime_seriousness_is_none(self):
        ...
        with pytest.raises(EntityError):
            Crime(crime_id="c303282d-f2e6-46ca-a04a-35d532532523523512", crime_description="The crime was extremely violent, leaving 6 citizens injured and 2 dead. The author left few clues behind.",
                  date=1585312648914, responsible_criminal=Criminal(name="VITOR", nickname="O destruidor de API", criminal_description="Esse criminoso terroriza os desenvolvedores front-end derrubando a API minutos antes da entrega. Não se sabe quantas vitimas morreram do coração achando que o erro era do front", gender=GENDER.UNDEFINED, criminal_region=REGION.INDUSTRIAL_DISTRICT, blood_type=BLOOD_TYPE.O_PLUS, age=21, weight=65.6, height=1.90),
                  crime_type=None, crime_region=None, seriousness=None)
    ...
    def test_crime_seriousness_is_not_seriousness(self):
        ...
        with pytest.raises(EntityError):
            Crime(crime_id="c303282d-f2e6-46ca-a04a-35d532532523523512", crime_description=15,
                  date=1232131, responsible_criminal=Criminal(name="VITOR", nickname="O destruidor de API", criminal_description="Esse criminoso terroriza os desenvolvedores front-end derrubando a API minutos antes da entrega. Não se sabe quantas vitimas morreram do coração achando que o erro era do front", gender=GENDER.UNDEFINED, criminal_region=REGION.INDUSTRIAL_DISTRICT, blood_type=BLOOD_TYPE.O_PLUS, age=21, weight=65.6, height=1.90),
                  crime_type=30, crime_region="São Caetano do Sul", seriousness=50)
